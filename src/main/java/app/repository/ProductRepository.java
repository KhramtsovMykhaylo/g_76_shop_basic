...
В качестве имитации базы данных у нас будет выступать Лист.

Репозиторий, как правило, реализует CRUD-функционал.
CRUD - Create Read Update Delete

Репозиторий не должен содержать бизнес-логику обработки объектов,
так как это задача уже третьего слоя - сервисов.
 */
