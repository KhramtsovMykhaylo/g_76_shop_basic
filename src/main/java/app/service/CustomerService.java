...
import app.exception.CustomerSaveException;
import app.exception.CustomerUpdateException;
...
public class CustomerService {
    ...
    public void update(Long id, String newName) {
        if (newName == null || newName.trim().isEmpty()) {
            throw new CustomerUpdateException("Имя покупвтеля не должно быть пустым.");
        }
...
//Вернуть стоимость корзины покупателя по его идентификатору (если он активен).
    ...
    public double getCustomerCartTotalCoast(Long id) {
    ...
    //Вернуть среднюю стоимость продукта в корзине покупателя по его идентификатору (если он активен)
    public double getCustomerCartAveragePrice(Long id) {
        return getActiveCustomerById(id)
                .getCart()
                .stream()
                .filter(Product::isActive)
    ...
    public void addProductCustomerCart(Long customerId, Long productId) {
    ...
    //Удалить товар из корзины покупателя по их идентификаторам.
    public void removeProductCustomerCart(Long customerId, Long productId) {
        Customer customer = getActiveCustomerById(customerId);
